...
!!! note "Disabled"
    ...
    this feature is not publicly available, there is currently no way to unlock this feature. However, feel free to join the [support server](https://discord.com/invite/rEsA5pZz4u).
